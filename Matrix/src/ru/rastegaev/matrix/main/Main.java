...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(matrix3.toString());                         // умножение на скаляр
        ...
        matrix4.sum(matrix1);                                               // сложение матриц
        System.out.println(matrix4.toString());

        System.out.println("Из матрицы 4 вычли матрицу 1");
        matrix4.difference(matrix1);
        System.out.println(matrix4.toString());                          // вычитание матриц

        System.out.println("Статическая сумма матриц");
        System.out.println(Matrix.getSum(matrix4, matrix1).toString());     // static сумма

        System.out.println("Статическая разность матриц");
        System.out.println(Matrix.getDifference(matrix4, matrix1).toString()); // static разность
